...
- En recette pour voir ce qu'il donne dans le dossier du dépot `rm -rf public && hugo build && pagefind --site public/postes/ && hugo server`
...
J'ai repris cerux de la landing page
